...
mixin _$SearchMovieKeyword {
 ...
 bool? get adult;@JsonKey(name: 'backdrop_path') String? get backdropPath;@JsonKey(name: 'genre_ids') List<int>? get genreIds; int? get id;@JsonKey(name: "origin_country") List<String>? get originCountry;@JsonKey(name: 'original_name') String? get originalName;@JsonKey(name: 'media_type') String? get mediaType;@JsonKey(name: 'original_title') String? get originalTitle; String? get overview; String? get title; String? get name; int? get gender;@JsonKey(name: 'known_for') List<SearchMovieKeyword>? get knownFor;@JsonKey(name: 'known_for_department') String? get knownForDepartment;@JsonKey(name: 'poster_path') String? get posterPath;@JsonKey(name: 'profile_path') String? get profilePath;@JsonKey(name: 'original_language') String? get originalLanguage; double? get popularity;@JsonKey(name: 'first_air_date') String? get firstAirDate;@JsonKey(name: 'release_date') String? get releaseDate; bool? get video;@JsonKey(name: 'vote_average') double? get voteAverage;@JsonKey(name: 'vote_count') int? get voteCount;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchMovieKeyword&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other.genreIds, genreIds)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.originCountry, originCountry)&&(identical(other.originalName, originalName) || other.originalName == originalName)&&(identical(other.mediaType, mediaType) || other.mediaType == mediaType)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.title, title) || other.title == title)&&(identical(other.name, name) || other.name == name)&&(identical(other.gender, gender) || other.gender == gender)&&const DeepCollectionEquality().equals(other.knownFor, knownFor)&&(identical(other.knownForDepartment, knownForDepartment) || other.knownForDepartment == knownForDepartment)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.profilePath, profilePath) || other.profilePath == profilePath)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.firstAirDate, firstAirDate) || other.firstAirDate == firstAirDate)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,adult,backdropPath,const DeepCollectionEquality().hash(genreIds),id,const DeepCollectionEquality().hash(originCountry),originalName,mediaType,originalTitle,overview,title,name,gender,const DeepCollectionEquality().hash(knownFor),knownForDepartment,posterPath,profilePath,originalLanguage,popularity,firstAirDate,releaseDate,video,voteAverage,voteCount]);

@override
String toString() {
  return 'SearchMovieKeyword(adult: $adult, backdropPath: $backdropPath, genreIds: $genreIds, id: $id, originCountry: $originCountry, originalName: $originalName, mediaType: $mediaType, originalTitle: $originalTitle, overview: $overview, title: $title, name: $name, gender: $gender, knownFor: $knownFor, knownForDepartment: $knownForDepartment, posterPath: $posterPath, profilePath: $profilePath, originalLanguage: $originalLanguage, popularity: $popularity, firstAirDate: $firstAirDate, releaseDate: $releaseDate, video: $video, voteAverage: $voteAverage, voteCount: $voteCount)';
}
...
@useResult
$Res call({
 bool? adult,@JsonKey(name: 'backdrop_path') String? backdropPath,@JsonKey(name: 'genre_ids') List<int>? genreIds, int? id,@JsonKey(name: "origin_country") List<String>? originCountry,@JsonKey(name: 'original_name') String? originalName,@JsonKey(name: 'media_type') String? mediaType,@JsonKey(name: 'original_title') String? originalTitle, String? overview, String? title, String? name, int? gender,@JsonKey(name: 'known_for') List<SearchMovieKeyword>? knownFor,@JsonKey(name: 'known_for_department') String? knownForDepartment,@JsonKey(name: 'poster_path') String? posterPath,@JsonKey(name: 'profile_path') String? profilePath,@JsonKey(name: 'original_language') String? originalLanguage, double? popularity,@JsonKey(name: 'first_air_date') String? firstAirDate,@JsonKey(name: 'release_date') String? releaseDate, bool? video,@JsonKey(name: 'vote_average') double? voteAverage,@JsonKey(name: 'vote_count') int? voteCount
});
...
as List<SearchMovieKeyword>?,knownForDepartment: freezed == knownForDepartment ? _self.knownForDepartment : knownForDepartment // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool? adult, @JsonKey(name: 'backdrop_path')  String? backdropPath, @JsonKey(name: 'genre_ids')  List<int>? genreIds,  int? id, @JsonKey(name: "origin_country")  List<String>? originCountry, @JsonKey(name: 'original_name')  String? originalName, @JsonKey(name: 'media_type')  String? mediaType, @JsonKey(name: 'original_title')  String? originalTitle,  String? overview,  String? title,  String? name,  int? gender, @JsonKey(name: 'known_for')  List<SearchMovieKeyword>? knownFor, @JsonKey(name: 'known_for_department')  String? knownForDepartment, @JsonKey(name: 'poster_path')  String? posterPath, @JsonKey(name: 'profile_path')  String? profilePath, @JsonKey(name: 'original_language')  String? originalLanguage,  double? popularity, @JsonKey(name: 'first_air_date')  String? firstAirDate, @JsonKey(name: 'release_date')  String? releaseDate,  bool? video, @JsonKey(name: 'vote_average')  double? voteAverage, @JsonKey(name: 'vote_count')  int? voteCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchMovieKeyword() when $default != null:
return $default(_that.adult,_that.backdropPath,_that.genreIds,_that.id,_that.originCountry,_that.originalName,_that.mediaType,_that.originalTitle,_that.overview,_that.title,_that.name,_that.gender,_that.knownFor,_that.knownForDepartment,_that.posterPath,_that.profilePath,_that.originalLanguage,_that.popularity,_that.firstAirDate,_that.releaseDate,_that.video,_that.voteAverage,_that.voteCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool? adult, @JsonKey(name: 'backdrop_path')  String? backdropPath, @JsonKey(name: 'genre_ids')  List<int>? genreIds,  int? id, @JsonKey(name: "origin_country")  List<String>? originCountry, @JsonKey(name: 'original_name')  String? originalName, @JsonKey(name: 'media_type')  String? mediaType, @JsonKey(name: 'original_title')  String? originalTitle,  String? overview,  String? title,  String? name,  int? gender, @JsonKey(name: 'known_for')  List<SearchMovieKeyword>? knownFor, @JsonKey(name: 'known_for_department')  String? knownForDepartment, @JsonKey(name: 'poster_path')  String? posterPath, @JsonKey(name: 'profile_path')  String? profilePath, @JsonKey(name: 'original_language')  String? originalLanguage,  double? popularity, @JsonKey(name: 'first_air_date')  String? firstAirDate, @JsonKey(name: 'release_date')  String? releaseDate,  bool? video, @JsonKey(name: 'vote_average')  double? voteAverage, @JsonKey(name: 'vote_count')  int? voteCount)  $default,) {final _that = this;
switch (_that) {
case _SearchMovieKeyword():
...
@override final  int? gender;
 final  List<SearchMovieKeyword>? _knownFor;
@override@JsonKey(name: 'known_for') List<SearchMovieKeyword>? get knownFor {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SearchMovieKeyword&&(identical(other.adult, adult) || other.adult == adult)&&(identical(other.backdropPath, backdropPath) || other.backdropPath == backdropPath)&&const DeepCollectionEquality().equals(other._genreIds, _genreIds)&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other._originCountry, _originCountry)&&(identical(other.originalName, originalName) || other.originalName == originalName)&&(identical(other.mediaType, mediaType) || other.mediaType == mediaType)&&(identical(other.originalTitle, originalTitle) || other.originalTitle == originalTitle)&&(identical(other.overview, overview) || other.overview == overview)&&(identical(other.title, title) || other.title == title)&&(identical(other.name, name) || other.name == name)&&(identical(other.gender, gender) || other.gender == gender)&&const DeepCollectionEquality().equals(other._knownFor, _knownFor)&&(identical(other.knownForDepartment, knownForDepartment) || other.knownForDepartment == knownForDepartment)&&(identical(other.posterPath, posterPath) || other.posterPath == posterPath)&&(identical(other.profilePath, profilePath) || other.profilePath == profilePath)&&(identical(other.originalLanguage, originalLanguage) || other.originalLanguage == originalLanguage)&&(identical(other.popularity, popularity) || other.popularity == popularity)&&(identical(other.firstAirDate, firstAirDate) || other.firstAirDate == firstAirDate)&&(identical(other.releaseDate, releaseDate) || other.releaseDate == releaseDate)&&(identical(other.video, video) || other.video == video)&&(identical(other.voteAverage, voteAverage) || other.voteAverage == voteAverage)&&(identical(other.voteCount, voteCount) || other.voteCount == voteCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,adult,backdropPath,const DeepCollectionEquality().hash(_genreIds),id,const DeepCollectionEquality().hash(_originCountry),originalName,mediaType,originalTitle,overview,title,name,gender,const DeepCollectionEquality().hash(_knownFor),knownForDepartment,posterPath,profilePath,originalLanguage,popularity,firstAirDate,releaseDate,video,voteAverage,voteCount]);
