...
import '../../domain/usecases/movie_recommendation_usecase.dart';

final movieRecommendationProvider = FutureProvider.autoDispose.family<TrendingMoviesEntity, ({String id, String type})>((ref, param) async {
